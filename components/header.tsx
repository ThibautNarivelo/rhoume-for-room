  ...
  return (
    <div>
      {socials?.map((social) => (
        <div
          key={social._id}
          className="bg-r-mainblack text-r-mainwhite static md:fixed h-[.2vw] w-screen top-0 left-0 right-0 ease-in-out duration-500 z-50"
        >
          <motion.div
            initial={{
              x: -500,
          ...
          >
            ...
            <Link href={social.url} className="header">
              ig
            </Link>
          </motion.div>
        </div>
